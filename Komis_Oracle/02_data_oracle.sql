...
-- UBEZPIECZENIE
TRUNCATE TABLE ubezpieczenie;

INSERT INTO ubezpieczenie
  (id_samochod, firma_ubezpieczeniowa, nr_polisy, data_poczatku, data_konca, koszt)
SELECT v.id_samochod,
       v.firma_ubezpieczeniowa,
       v.nr_polisy,
       v.data_poczatku,
       v.data_konca,
       v.koszt
FROM (
  SELECT 1 AS id_samochod, 'PZU'           AS firma_ubezpieczeniowa, 'POL000001' AS nr_polisy,
         TO_DATE('2023-01-01','YYYY-MM-DD') AS data_poczatku, TO_DATE('2024-01-01','YYYY-MM-DD') AS data_konca, 1250.50 AS koszt
  FROM dual
  UNION ALL SELECT 2,   'Allianz',     'POL000002', TO_DATE('2023-02-15','YYYY-MM-DD'), TO_DATE('2024-02-15','YYYY-MM-DD'), 1320.75 FROM dual
  UNION ALL SELECT 3,   'Warta',       'POL000003', TO_DATE('2022-07-10','YYYY-MM-DD'), TO_DATE('2023-07-10','YYYY-MM-DD'),  980.00 FROM dual
  UNION ALL SELECT 4,   'Link4',       'POL000004', TO_DATE('2023-03-05','YYYY-MM-DD'), TO_DATE('2024-03-05','YYYY-MM-DD'), 1120.00 FROM dual
  UNION ALL SELECT 5,   'Ergo Hestia', 'POL000005', TO_DATE('2023-04-20','YYYY-MM-DD'), TO_DATE('2024-04-20','YYYY-MM-DD'), 1400.25 FROM dual
  UNION ALL SELECT 6,   'Generali',    'POL000006', TO_DATE('2022-09-01','YYYY-MM-DD'), TO_DATE('2023-09-01','YYYY-MM-DD'),  890.90 FROM dual
  UNION ALL SELECT 7,   'Compensa',    'POL000007', TO_DATE('2023-05-01','YYYY-MM-DD'), TO_DATE('2024-05-01','YYYY-MM-DD'), 1010.00 FROM dual
  UNION ALL SELECT 8,   'InterRisk',   'POL000008', TO_DATE('2023-06-12','YYYY-MM-DD'), TO_DATE('2024-06-12','YYYY-MM-DD'), 1175.40 FROM dual
  UNION ALL SELECT 9,   'PZU',         'POL000009', TO_DATE('2023-07-20','YYYY-MM-DD'), TO_DATE('2024-07-20','YYYY-MM-DD'), 1100.60 FROM dual
  UNION ALL SELECT 10,  'Allianz',     'POL000010', TO_DATE('2023-08-15','YYYY-MM-DD'), TO_DATE('2024-08-15','YYYY-MM-DD'), 1350.00 FROM dual
  UNION ALL SELECT 11,  'Warta',       'POL000011', TO_DATE('2023-09-10','YYYY-MM-DD'), TO_DATE('2024-09-10','YYYY-MM-DD'),  950.30 FROM dual
  UNION ALL SELECT 12,  'Link4',       'POL000012', TO_DATE('2023-10-05','YYYY-MM-DD'), TO_DATE('2024-10-05','YYYY-MM-DD'), 1080.00 FROM dual
  UNION ALL SELECT 13,  'Ergo Hestia', 'POL000013', TO_DATE('2023-11-01','YYYY-MM-DD'), TO_DATE('2024-11-01','YYYY-MM-DD'), 1245.90 FROM dual
  UNION ALL SELECT 14,  'Generali',    'POL000014', TO_DATE('2023-12-12','YYYY-MM-DD'), TO_DATE('2024-12-12','YYYY-MM-DD'),  990.50 FROM dual
  UNION ALL SELECT 15,  'Compensa',    'POL000015', TO_DATE('2024-01-05','YYYY-MM-DD'), TO_DATE('2025-01-05','YYYY-MM-DD'), 1325.75 FROM dual
  UNION ALL SELECT 16,  'InterRisk',   'POL000016', TO_DATE('2024-02-10','YYYY-MM-DD'), TO_DATE('2025-02-10','YYYY-MM-DD'), 1070.00 FROM dual
  UNION ALL SELECT 17,  'PZU',         'POL000017', TO_DATE('2024-03-03','YYYY-MM-DD'), TO_DATE('2025-03-03','YYYY-MM-DD'), 1280.25 FROM dual
  UNION ALL SELECT 18,  'Allianz',     'POL000018', TO_DATE('2024-03-20','YYYY-MM-DD'), TO_DATE('2025-03-20','YYYY-MM-DD'), 1190.80 FROM dual
  UNION ALL SELECT 19,  'Warta',       'POL000019', TO_DATE('2024-04-10','YYYY-MM-DD'), TO_DATE('2025-04-10','YYYY-MM-DD'),  990.00 FROM dual
  UNION ALL SELECT 20,  'Link4',       'POL000020', TO_DATE('2024-04-25','YYYY-MM-DD'), TO_DATE('2025-04-25','YYYY-MM-DD'),  950.50 FROM dual
  UNION ALL SELECT 21,  'Ergo Hestia', 'POL000021', TO_DATE('2024-05-15','YYYY-MM-DD'), TO_DATE('2025-05-15','YYYY-MM-DD'), 1100.00 FROM dual
  UNION ALL SELECT 22,  'Generali',    'POL000022', TO_DATE('2024-06-01','YYYY-MM-DD'), TO_DATE('2025-06-01','YYYY-MM-DD'), 1025.00 FROM dual
  UNION ALL SELECT 23,  'Compensa',    'POL000023', TO_DATE('2024-06-20','YYYY-MM-DD'), TO_DATE('2025-06-20','YYYY-MM-DD'), 1320.00 FROM dual
  UNION ALL SELECT 24,  'InterRisk',   'POL000024', TO_DATE('2024-07-10','YYYY-MM-DD'), TO_DATE('2025-07-10','YYYY-MM-DD'),  950.00 FROM dual
  UNION ALL SELECT 25,  'PZU',         'POL000025', TO_DATE('2024-07-25','YYYY-MM-DD'), TO_DATE('2025-07-25','YYYY-MM-DD'), 1175.00 FROM dual
  UNION ALL SELECT 26,  'Allianz',     'POL000026', TO_DATE('2024-08-10','YYYY-MM-DD'), TO_DATE('2025-08-10','YYYY-MM-DD'), 1120.00 FROM dual
  UNION ALL SELECT 27,  'Warta',       'POL000027', TO_DATE('2024-08-25','YYYY-MM-DD'), TO_DATE('2025-08-25','YYYY-MM-DD'),  985.00 FROM dual
  UNION ALL SELECT 28,  'Link4',       'POL000028', TO_DATE('2024-09-10','YYYY-MM-DD'), TO_DATE('2025-09-10','YYYY-MM-DD'), 1090.00 FROM dual
  UNION ALL SELECT 29,  'Ergo Hestia', 'POL000029', TO_DATE('2024-09-25','YYYY-MM-DD'), TO_DATE('2025-09-25','YYYY-MM-DD'), 1180.00 FROM dual
  UNION ALL SELECT 30,  'Generali',    'POL000030', TO_DATE('2024-10-10','YYYY-MM-DD'), TO_DATE('2025-10-10','YYYY-MM-DD'), 1260.00 FROM dual
  UNION ALL SELECT 31,  'Compensa',    'POL000031', TO_DATE('2024-10-25','YYYY-MM-DD'), TO_DATE('2025-10-25','YYYY-MM-DD'), 1040.00 FROM dual
  UNION ALL SELECT 32,  'InterRisk',   'POL000032', TO_DATE('2024-11-10','YYYY-MM-DD'), TO_DATE('2025-11-10','YYYY-MM-DD'), 1085.00 FROM dual
  UNION ALL SELECT 33,  'PZU',         'POL000033', TO_DATE('2024-11-25','YYYY-MM-DD'), TO_DATE('2025-11-25','YYYY-MM-DD'), 1125.00 FROM dual
  UNION ALL SELECT 34,  'Allianz',     'POL000034', TO_DATE('2024-12-10','YYYY-MM-DD'), TO_DATE('2025-12-10','YYYY-MM-DD'),  980.00 FROM dual
  UNION ALL SELECT 35,  'Warta',       'POL000035', TO_DATE('2024-12-25','YYYY-MM-DD'), TO_DATE('2025-12-25','YYYY-MM-DD'), 1200.00 FROM dual
  UNION ALL SELECT 36,  'Link4',       'POL000036', TO_DATE('2025-01-10','YYYY-MM-DD'), TO_DATE('2026-01-10','YYYY-MM-DD'), 1350.00 FROM dual
  UNION ALL SELECT 37,  'Ergo Hestia', 'POL000037', TO_DATE('2025-01-25','YYYY-MM-DD'), TO_DATE('2026-01-25','YYYY-MM-DD'), 1250.00 FROM dual
  UNION ALL SELECT 38,  'Generali',    'POL000038', TO_DATE('2025-02-10','YYYY-MM-DD'), TO_DATE('2026-02-10','YYYY-MM-DD'), 1100.00 FROM dual
  UNION ALL SELECT 39,  'Compensa',    'POL000039', TO_DATE('2025-02-25','YYYY-MM-DD'), TO_DATE('2026-02-25','YYYY-MM-DD'), 1050.00 FROM dual
  UNION ALL SELECT 40,  'InterRisk',   'POL000040', TO_DATE('2025-03-10','YYYY-MM-DD'), TO_DATE('2026-03-10','YYYY-MM-DD'), 1020.00 FROM dual
  UNION ALL SELECT 41,  'PZU',         'POL000041', TO_DATE('2025-03-25','YYYY-MM-DD'), TO_DATE('2026-03-25','YYYY-MM-DD'), 1115.00 FROM dual
  UNION ALL SELECT 42,  'Allianz',     'POL000042', TO_DATE('2025-04-10','YYYY-MM-DD'), TO_DATE('2026-04-10','YYYY-MM-DD'), 1080.00 FROM dual
  UNION ALL SELECT 43,  'Warta',       'POL000043', TO_DATE('2025-04-25','YYYY-MM-DD'), TO_DATE('2026-04-25','YYYY-MM-DD'),  975.00 FROM dual
  UNION ALL SELECT 44,  'Link4',       'POL000044', TO_DATE('2025-05-10','YYYY-MM-DD'), TO_DATE('2026-05-10','YYYY-MM-DD'),  950.00 FROM dual
  UNION ALL SELECT 45,  'Ergo Hestia', 'POL000045', TO_DATE('2025-05-25','YYYY-MM-DD'), TO_DATE('2026-05-25','YYYY-MM-DD'),  990.00 FROM dual
  UNION ALL SELECT 46,  'Generali',    'POL000046', TO_DATE('2025-06-10','YYYY-MM-DD'), TO_DATE('2026-06-10','YYYY-MM-DD'), 1000.00 FROM dual
  UNION ALL SELECT 47,  'Compensa',    'POL000047', TO_DATE('2025-06-25','YYYY-MM-DD'), TO_DATE('2026-06-25','YYYY-MM-DD'), 1075.00 FROM dual
  UNION ALL SELECT 48,  'InterRisk',   'POL000048', TO_DATE('2025-07-10','YYYY-MM-DD'), TO_DATE('2026-07-10','YYYY-MM-DD'), 1120.00 FROM dual
  UNION ALL SELECT 49,  'PZU',         'POL000049', TO_DATE('2025-07-25','YYYY-MM-DD'), TO_DATE('2026-07-25','YYYY-MM-DD'), 1160.00 FROM dual
  UNION ALL SELECT 50,  'Allianz',     'POL000050', TO_DATE('2025-08-10','YYYY-MM-DD'), TO_DATE('2026-08-10','YYYY-MM-DD'), 1040.00 FROM dual
  UNION ALL SELECT 51,  'Warta',       'POL000051', TO_DATE('2025-08-25','YYYY-MM-DD'), TO_DATE('2026-08-25','YYYY-MM-DD'),  975.00 FROM dual
  UNION ALL SELECT 52,  'Link4',       'POL000052', TO_DATE('2025-09-10','YYYY-MM-DD'), TO_DATE('2026-09-10','YYYY-MM-DD'),  980.00 FROM dual
  UNION ALL SELECT 53,  'Ergo Hestia', 'POL000053', TO_DATE('2025-09-25','YYYY-MM-DD'), TO_DATE('2026-09-25','YYYY-MM-DD'),  995.00 FROM dual
  UNION ALL SELECT 54,  'Generali',    'POL000054', TO_DATE('2025-10-10','YYYY-MM-DD'), TO_DATE('2026-10-10','YYYY-MM-DD'), 1000.00 FROM dual
  UNION ALL SELECT 55,  'Compensa',    'POL000055', TO_DATE('2025-10-25','YYYY-MM-DD'), TO_DATE('2026-10-25','YYYY-MM-DD'), 1025.00 FROM dual
  UNION ALL SELECT 56,  'InterRisk',   'POL000056', TO_DATE('2025-11-10','YYYY-MM-DD'), TO_DATE('2026-11-10','YYYY-MM-DD'), 1070.00 FROM dual
  UNION ALL SELECT 57,  'PZU',         'POL000057', TO_DATE('2025-11-25','YYYY-MM-DD'), TO_DATE('2026-11-25','YYYY-MM-DD'), 1095.00 FROM dual
  UNION ALL SELECT 58,  'Allianz',     'POL000058', TO_DATE('2025-12-10','YYYY-MM-DD'), TO_DATE('2026-12-10','YYYY-MM-DD'), 1110.00 FROM dual
  UNION ALL SELECT 59,  'Warta',       'POL000059', TO_DATE('2025-12-25','YYYY-MM-DD'), TO_DATE('2026-12-25','YYYY-MM-DD'), 1125.00 FROM dual
  UNION ALL SELECT 60,  'Link4',       'POL000060', TO_DATE('2026-01-10','YYYY-MM-DD'), TO_DATE('2027-01-10','YYYY-MM-DD'), 1150.00 FROM dual
  UNION ALL SELECT 61,  'Ergo Hestia', 'POL000061', TO_DATE('2026-01-25','YYYY-MM-DD'), TO_DATE('2027-01-25','YYYY-MM-DD'), 1200.00 FROM dual
  UNION ALL SELECT 62,  'Generali',    'POL000062', TO_DATE('2026-02-10','YYYY-MM-DD'), TO_DATE('2027-02-10','YYYY-MM-DD'), 1220.00 FROM dual
  UNION ALL SELECT 63,  'Compensa',    'POL000063', TO_DATE('2026-02-25','YYYY-MM-DD'), TO_DATE('2027-02-25','YYYY-MM-DD'), 1235.00 FROM dual
  UNION ALL SELECT 64,  'InterRisk',   'POL000064', TO_DATE('2026-03-10','YYYY-MM-DD'), TO_DATE('2027-03-10','YYYY-MM-DD'), 1250.00 FROM dual
  UNION ALL SELECT 65,  'PZU',         'POL000065', TO_DATE('2026-03-25','YYYY-MM-DD'), TO_DATE('2027-03-25','YYYY-MM-DD'), 1275.00 FROM dual
  UNION ALL SELECT 66,  'Allianz',     'POL000066', TO_DATE('2026-04-10','YYYY-MM-DD'), TO_DATE('2027-04-10','YYYY-MM-DD'), 1290.00 FROM dual
  UNION ALL SELECT 67,  'Warta',       'POL000067', TO_DATE('2026-04-25','YYYY-MM-DD'), TO_DATE('2027-04-25','YYYY-MM-DD'), 1305.00 FROM dual
  UNION ALL SELECT 68,  'Link4',       'POL000068', TO_DATE('2026-05-10','YYYY-MM-DD'), TO_DATE('2027-05-10','YYYY-MM-DD'), 1320.00 FROM dual
  UNION ALL SELECT 69,  'Ergo Hestia', 'POL000069', TO_DATE('2026-05-25','YYYY-MM-DD'), TO_DATE('2027-05-25','YYYY-MM-DD'), 1340.00 FROM dual
  UNION ALL SELECT 70,  'Generali',    'POL000070', TO_DATE('2026-06-10','YYYY-MM-DD'), TO_DATE('2027-06-10','YYYY-MM-DD'), 1360.00 FROM dual
  UNION ALL SELECT 71,  'Compensa',    'POL000071', TO_DATE('2026-06-25','YYYY-MM-DD'), TO_DATE('2027-06-25','YYYY-MM-DD'), 1380.00 FROM dual
  UNION ALL SELECT 72,  'InterRisk',   'POL000072', TO_DATE('2026-07-10','YYYY-MM-DD'), TO_DATE('2027-07-10','YYYY-MM-DD'), 1400.00 FROM dual
  UNION ALL SELECT 73,  'PZU',         'POL000073', TO_DATE('2026-07-25','YYYY-MM-DD'), TO_DATE('2027-07-25','YYYY-MM-DD'), 1425.00 FROM dual
  UNION ALL SELECT 74,  'Allianz',     'POL000074', TO_DATE('2026-08-10','YYYY-MM-DD'), TO_DATE('2027-08-10','YYYY-MM-DD'), 1450.00 FROM dual
  UNION ALL SELECT 75,  'Warta',       'POL000075', TO_DATE('2026-08-25','YYYY-MM-DD'), TO_DATE('2027-08-25','YYYY-MM-DD'), 1475.00 FROM dual
  UNION ALL SELECT 76,  'Link4',       'POL000076', TO_DATE('2026-09-10','YYYY-MM-DD'), TO_DATE('2027-09-10','YYYY-MM-DD'), 1490.00 FROM dual
  UNION ALL SELECT 77,  'Ergo Hestia', 'POL000077', TO_DATE('2026-09-25','YYYY-MM-DD'), TO_DATE('2027-09-25','YYYY-MM-DD'), 1500.00 FROM dual
  UNION ALL SELECT 78,  'Generali',    'POL000078', TO_DATE('2026-10-10','YYYY-MM-DD'), TO_DATE('2027-10-10','YYYY-MM-DD'), 1515.00 FROM dual
  UNION ALL SELECT 79,  'Compensa',    'POL000079', TO_DATE('2026-10-25','YYYY-MM-DD'), TO_DATE('2027-10-25','YYYY-MM-DD'), 1530.00 FROM dual
  UNION ALL SELECT 80,  'InterRisk',   'POL000080', TO_DATE('2026-11-10','YYYY-MM-DD'), TO_DATE('2027-11-10','YYYY-MM-DD'), 1550.00 FROM dual
  UNION ALL SELECT 81,  'PZU',         'POL000081', TO_DATE('2026-11-25','YYYY-MM-DD'), TO_DATE('2027-11-25','YYYY-MM-DD'), 1575.00 FROM dual
  UNION ALL SELECT 82,  'Allianz',     'POL000082', TO_DATE('2026-12-10','YYYY-MM-DD'), TO_DATE('2027-12-10','YYYY-MM-DD'), 1600.00 FROM dual
  UNION ALL SELECT 83,  'Warta',       'POL000083', TO_DATE('2026-12-25','YYYY-MM-DD'), TO_DATE('2027-12-25','YYYY-MM-DD'), 1625.00 FROM dual
  UNION ALL SELECT 84,  'Link4',       'POL000084', TO_DATE('2027-01-10','YYYY-MM-DD'), TO_DATE('2028-01-10','YYYY-MM-DD'), 1650.00 FROM dual
  UNION ALL SELECT 85,  'Ergo Hestia', 'POL000085', TO_DATE('2027-01-25','YYYY-MM-DD'), TO_DATE('2028-01-25','YYYY-MM-DD'), 1675.00 FROM dual
  UNION ALL SELECT 86,  'Generali',    'POL000086', TO_DATE('2027-02-10','YYYY-MM-DD'), TO_DATE('2028-02-10','YYYY-MM-DD'), 1700.00 FROM dual
  UNION ALL SELECT 87,  'Compensa',    'POL000087', TO_DATE('2027-02-25','YYYY-MM-DD'), TO_DATE('2028-02-25','YYYY-MM-DD'), 1720.00 FROM dual
  UNION ALL SELECT 88,  'InterRisk',   'POL000088', TO_DATE('2027-03-10','YYYY-MM-DD'), TO_DATE('2028-03-10','YYYY-MM-DD'), 1740.00 FROM dual
  UNION ALL SELECT 89,  'PZU',         'POL000089', TO_DATE('2027-03-25','YYYY-MM-DD'), TO_DATE('2028-03-25','YYYY-MM-DD'), 1760.00 FROM dual
  UNION ALL SELECT 90,  'Allianz',     'POL000090', TO_DATE('2027-04-10','YYYY-MM-DD'), TO_DATE('2028-04-10','YYYY-MM-DD'), 1785.00 FROM dual
  UNION ALL SELECT 91,  'Warta',       'POL000091', TO_DATE('2027-04-25','YYYY-MM-DD'), TO_DATE('2028-04-25','YYYY-MM-DD'), 1800.00 FROM dual
  UNION ALL SELECT 92,  'Link4',       'POL000092', TO_DATE('2027-05-10','YYYY-MM-DD'), TO_DATE('2028-05-10','YYYY-MM-DD'), 1825.00 FROM dual
  UNION ALL SELECT 93,  'Ergo Hestia', 'POL000093', TO_DATE('2027-05-25','YYYY-MM-DD'), TO_DATE('2028-05-25','YYYY-MM-DD'), 1850.00 FROM dual
  UNION ALL SELECT 94,  'Generali',    'POL000094', TO_DATE('2027-06-10','YYYY-MM-DD'), TO_DATE('2028-06-10','YYYY-MM-DD'), 1875.00 FROM dual
  UNION ALL SELECT 95,  'Compensa',    'POL000095', TO_DATE('2027-06-25','YYYY-MM-DD'), TO_DATE('2028-06-25','YYYY-MM-DD'), 1900.00 FROM dual
  UNION ALL SELECT 96,  'InterRisk',   'POL000096', TO_DATE('2027-07-10','YYYY-MM-DD'), TO_DATE('2028-07-10','YYYY-MM-DD'), 1925.00 FROM dual
  UNION ALL SELECT 97,  'PZU',         'POL000097', TO_DATE('2027-07-25','YYYY-MM-DD'), TO_DATE('2028-07-25','YYYY-MM-DD'), 1950.00 FROM dual
  UNION ALL SELECT 98,  'Allianz',     'POL000098', TO_DATE('2027-08-10','YYYY-MM-DD'), TO_DATE('2028-08-10','YYYY-MM-DD'), 1975.00 FROM dual
  UNION ALL SELECT 99,  'Warta',       'POL000099', TO_DATE('2027-08-25','YYYY-MM-DD'), TO_DATE('2028-08-25','YYYY-MM-DD'), 1990.00 FROM dual
  UNION ALL SELECT 100, 'Link4',       'POL000100', TO_DATE('2027-09-10','YYYY-MM-DD'), TO_DATE('2028-09-10','YYYY-MM-DD'), 2000.00 FROM dual
) v;

COMMIT;

-- kontrola
SELECT MIN(id_ubezpieczenie) min_id,
       MAX(id_ubezpieczenie) max_id,
       COUNT(*) ile
FROM ubezpieczenie;
